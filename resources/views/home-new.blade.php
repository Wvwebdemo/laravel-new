...
@section('content')
        ...
        <section class="feature-section sec-pad">
            <div class="pattern">
                <div class="pattern-1 wow zoomIn animated" data-wow-delay="00ms" data-wow-duration="1500ms" style="background-image: url(assets/images/shape/shape-16.png);"></div>
                <div class="pattern-2 wow zoomIn animated" data-wow-delay="00ms" data-wow-duration="1500ms" style="background-image: url(assets/images/shape/shape-17.png);"></div>
            </div>
            <div class="auto-container">
                ...
                <div class="row align-items-center clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image_block_3">
                            <div class="image-box">
                                <div class="shape">
                                    <div class="shape-1 rotate-me" style="background-image: url(assets/images/shape/shape-18.png);"></div>
                                    <div class="shape-2" style="background-image: url(assets/images/shape/shape-19.png);"></div>
                                    <div class="shape-3" style="background-image: url(assets/images/shape/shape-20.png);"></div>
                                </div>
                                <figure class="image"><img src="assets/images/resource/about-2.png" alt=""></figure>
                                <div class="text">
                                    <h2>20</h2>
                                    <h5>Years of exps</h5>
                                </div>
        ...
        <section class="chooseus-section sec-pad bg-color-1">
            ...
            <div class="bg-layer" style="background-image: url(assets/images/background/chooseus-1.jpg);"></div>
            <div class="auto-container">
                <div class="row clearfix">
                ...
                <div class="row clearfix">
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <ul class="thumb-list clearfix">
                                        <li>
                                            <figure class="image"><img src="assets/images/resource/thumb-1.png" alt=""></figure>
                                        </li>
                                        <li>
                                            <figure class="image"><img src="assets/images/resource/thumb-2.png" alt=""></figure>
                                        </li>
                                        <li>
                                            <figure class="image"><img src="assets/images/resource/thumb-3.png" alt=""></figure>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 event-block">
                        <div class="event-block-one wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"> 
                                    <img src="assets/images/event/event-3.jpg" alt="">
                                    <a href="event-details.html"><i class="fas fa-link"></i></a>
                                </figure>
                                <div class="lower-content">
